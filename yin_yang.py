...
for n in range(len(labels)):
    ...
    dist_x = np.zeros(timespan, dtype = int) #np.concatenate((np.ones(num_spikes_x, dtype=int), np.zeros(timespan - num_spikes_x, dtype=int)))
    dist_y = np.zeros(timespan, dtype = int) #np.concatenate((np.ones(num_spikes_y, dtype=int), np.zeros(timespan - num_spikes_y, dtype=int)))
    dist_1_x = np.zeros(timespan, dtype = int) #np.concatenate((np.ones(num_spikes_1_x, dtype=int), np.zeros(timespan - num_spikes_1_x, dtype=int)))
    dist_1_y = np.zeros(timespan, dtype = int) #np.concatenate((np.ones(num_spikes_1_y, dtype=int), np.zeros(timespan - num_spikes_1_y, dtype=int)))
